...
const SECTIONS: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Starter is free and includes the lead engine, ROI calculator, and validation (up to 3 leads/week). Pro ($50/mo) unlocks Amazon SP-API, inventory sync, sales & profit tracking, profit recovery, report imports, and the repricing approval queue (up to 20 leads/week).',
      },
      {
    ...
    items: [
      {
        ...
        a: (
          <>
            ...
            shows leads generated by the{' '}
            <Link href="/dashboard/scanner" className="text-blue-400 hover:text-blue-300">Scanner</Link>.
            If you have not run a scan yet, or if scanner access is pending for your account, the feed will be empty. Contact support if you expect access but the scanner is not available.
          </>
        ),
      },
      {
      ...
      {
        q: 'Why might Scanner access be pending?',
        a: 'Scanner access is controlled per account and must be enabled by the EALLsource team. If the Scanner page is not available, contact support@eallsource.com to request access.',
      },
    ],
  },
  {
