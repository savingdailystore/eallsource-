  ...
  return (
    <div className="p-6 lg:p-8 max-w-5xl">
      <div className="flex items-center gap-3 mb-5">
        <Link href="/dashboard/products" className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-slate-200">
          <ArrowLeft className="w-4 h-4" />Back to Products
        </Link>
        {lead && (
          <>
            <span className="text-slate-600">·</span>
            <Link href={`/dashboard/leads/${lead.id}`} className="inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-400">
      ...
      <div className="grid lg:grid-cols-3 gap-5">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-3">
              {[
                ...
                <div key={lbl as string}>
                  ...
                  <div className="text-sm font-medium text-slate-100 mt-0.5">{val}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="space-y-5">
          ...
          <div className="card p-5">
            ...
            {[
              ...
              <div key={lbl as string} className="flex items-center justify-between py-2 border-b border-slate-800 last:border-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono w-10 text-right text-slate-200">{((val as number) ?? 0).toFixed(0)}%</span>
                  {(pass as boolean)
            ...
            <div className="mt-3 text-xs text-slate-500">All scores must be ≥ 95% to display. Match ≥ 70%.</div>
          </div>
