        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.7)' }}>
          <div className="bg-slate-900 rounded-2xl shadow-xl w-full max-w-lg">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
              <h2 className="font-semibold text-slate-50">Import Inventory from File</h2>
            ...
            <div className="px-6 py-5 space-y-4">
              <p className="text-sm text-slate-400">
                ...
                (such as an exported Amazon FBA inventory report). The only required column is <span className="font-mono text-slate-200">asin</span>.
              ...
              <button onClick={downloadTemplate} className="flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-400 font-medium">
              ...
              <div
                ...
                className="border-2 border-dashed border-slate-800 rounded-xl px-4 py-8 text-center cursor-pointer hover:border-blue-300 hover:bg-blue-500/10 transition-colors"
              >
                ...
                {fileName ? (
                  ...
                  <div className="text-sm text-slate-500">
                    <Upload className="w-6 h-6 mx-auto mb-2 text-slate-600" />
